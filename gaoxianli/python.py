...
class CodeCounter():
	...
	def __init__(self, path, language):		
		...
		self.total_files = 0# 统计常见的13种程序语言,以及对应的源码文件扩展名和注释符号（分单行注释和多行注释）
		...
		self.languages = {
			'javascript': {'ext':['.js'], 'single_line_comment':'//', 'multi_lines_comment':{'start':"/*", 'end':"*/"}},	# 这是注释
